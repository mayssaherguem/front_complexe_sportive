...
export class PieChartComponent implements OnInit {
  ...
  drawChart()
  {
    ...
    var sportsIcon = {
        'a': 'assets/images/gym.png',
        'b': 'assets/images/basketball.png',
        'c': 'assets/images/football.png',
        'd': 'assets/images/tennis.png',
        'e': 'assets/images/piscine.png',
    };
    this.option  = {
                      ...
                      formatter: function(params) {
                          ...
                          switch (params.name) {
                              case 'Gym':
                                  ...
                                  break;
                              case 'BasketBall':
                                  str = '{b|}\n{nameStyle|BasketBall }' + '{rate|\n' + params.value + '%}';
                                  break;
                              case 'FootBall':
                                  str = '{c|}\n{nameStyle|FootBall }' + '{rate|\n' + params.value + '%}';
                                  break;
                              case 'Tennis':
                                  str = '{d|}\n{nameStyle|Tennis }' + '{rate|\n' + params.value + '%}';
                                  break;
                              case 'Piscine':
                                  str = '{e|}\n{nameStyle|Piscine }' + '{rate|\n' + params.value + '%}';
                                  break;
                          }
                          return str
                      },
